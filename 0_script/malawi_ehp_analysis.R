...
summary = rbind(scen1, scen2, scen3, scen4, scen5, scen6, scen8)
...
coverage_byscenario = cbind(data.frame$category, data.frame$code, data.frame$intervention, scen1_coverage, scen2_coverage, scen3_coverage, scen4_coverage, scen5_coverage, scen6_coverage, scen8_coverage)
